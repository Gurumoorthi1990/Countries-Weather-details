...
response
  ...
  .then((result) => {
    //console.log(result)
    //allocating coutry details to the card
...
`;
    ...
    //Button logic for appanding weather details from weather api
...
let lat=latlng[0];
let lon=latlng[1];
let weatherApi=fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&appid=bb03bc04ce96c405c1d8333aef70d636`)
